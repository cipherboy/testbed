...
public class Client {
    ...
    public final static boolean test_handshake = true;
    ...
    public final static String[] safe_suites = {
            "TLS_DHE_RSA_WITH_AES_128_CBC_SHA",
            "TLS_DHE_RSA_WITH_AES_128_CBC_SHA256",
            "TLS_DHE_RSA_WITH_AES_128_GCM_SHA256",
            "TLS_DHE_RSA_WITH_AES_256_CBC_SHA",
    ...
    public static void testCipherSuites(String protocol) throws Exception {
        System.out.println("Testing Cipher Suites under protocol: " + protocol);
        ...
        for (String cipher_suite : cipher_suites) {
            try {
                ...
                SSLEngine engine = ctx.createSSLEngine("www.google.com", 443);
    ...
    public static void testHandshake(String protocol, String host, String port) throws Exception {
        System.out.println("Testing Cipher Suites under protocol: " + protocol);
        ...
        for (String cipher_suite : cipher_suites) {
            try {
                ...
                SSLConnectionSocketFactory scsf = new SSLConnectionSocketFactory(ctx, enabled_protocols, safe_suites, SSLConnectionSocketFactory.ALLOW_ALL_HOSTNAME_VERIFIER);

                CloseableHttpClient chc = HttpClients.custom().setHostnameVerifier(SSLConnectionSocketFactory.ALLOW_ALL_HOSTNAME_VERIFIER).setSSLSocketFactory(scsf).build();

                try {
                    HttpGet httpget = new HttpGet("https://" + host + ":" + port + "/");
                ...
                // System.out.println(" - " + cipher_suite + " :: Unsupported - Refusing to Handshake");
                if (!iae.getMessage().equals("Unsupported ciphersuite " + cipher_suite)) {
                    throw iae;
                }
/*            } catch (SSLHandshakeException she) {
                // System.out.println(" - " + cipher_suite + " :: Failed - " + she.getMessage()); */
    ...
    public static void testHandshake(String protocol) throws Exception {
        System.out.println("Testing Cipher Suites under protocol: " + protocol);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (test_handshake) {
            testHandshake(protocol, "google.com", "443");
        }
    }
}
